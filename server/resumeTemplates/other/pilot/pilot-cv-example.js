...
<head>
    ...
    <title>Contract Pilot - StyleMyCV</title>

    <meta name="description" content="Contract Pilot">
...
<body data-cv-id="3091062" class="cv-viewer">
            ...
            <div class="cv-content single-column">
                <section id="profile" class="profile">
                    <article class="vcard " data-bind="content">
                        ...
                        <div class="fn user-title">
                            <h1 class="full-name" data-bind="full_name"><span class="undefined needsclick" contenteditable="false" data-placeholder="Full name">Eilonwy Riggs</span></h1>
                            <div class="block-separator"></div>
                            <h2 class="title" data-bind="headline"><span class="undefined needsclick" contenteditable="false" data-placeholder="Headline / current title">Contract Pilot</span></h2></div>
                        <ul class="user-contact">
                            <li class="adr locality" data-bind="location"><span class="undefined needsclick" contenteditable="false" data-placeholder="Location">New York</span></li>
                            ...
                            <li class="email" data-bind="email"><a href="../cdn-cgi/l/email-protection#83e6fbe2eef3efe6c3e6eee2eaefade0ecee"><span class="__cf_email__" data-cfemail="791c01181409151c391c14181015571a1614">[email&#160;protected]</span></a></li>
                        </ul>
                ...
                <section data-bind="sections" id="summary" class="text_story">
                    ...
                    <article data-bind="content" class="">
                        <div id="react-tinymce-1032076" class=" mce-content-body" spellcheck="true" placeholder="Description">
                            <ul>
                                <li><span><span>C</span>ommercial contract pilot</span>
                                </li>
                                <li><span>Experience</span>&nbsp;in the commercial aviation industry</li>
                                <li><span>C</span>ommercial skydiving pilot</li>
                                <li>Experience teaching, grading, and testing students in aviation</li>
                                <li><span>Transportation of passengers and cargo by air</span></li>
                            </ul>
                        </div>
                    </article>
                </section>
                <section data-bind="sections" id="positions" class="dated_story">
                    ...
                    <article data-bind="contents" class="">
                        ...
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="Organization">Contract Pilot</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">Skyward Aviation</span></h4>
                            <div id="react-tinymce-1032078" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                <ul>
                                    <li><span>Provided on-call relief&nbsp;</span></li>
                                    <li><span><span>Responsible for transporting company executives</span></span>
                                    </li>
                                    <li><span><span><span>Aviation and management</span></span>
                                        </span>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <article data-bind="contents" class="">
                        ...
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="Organization">Flight Instructor</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">Tod Aviation School</span></h4>
                            <div id="react-tinymce-1032080" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                <ul>
                                    <li>T<span>each</span> students of aircraft systems, maintenance, and handling</li>
                                    <li><span>Responsible for grading, tests, and assessment</span><span><span></span></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <article data-bind="contents" class="">
                        <div class="article-headings">
                            <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">2000</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">2009</span></span></h6></div>
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="Organization">Pilot</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">Skyward Aviation</span></h4>
                            <div id="react-tinymce-1032082" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                <ul>
                                    <li><span><span>P</span>lanned and execut<span>ed&nbsp;</span>domestic and international flights</span>
                                    </li>
                                    <li><span><span>Responsible for transporting passengers</span></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <article data-bind="contents" class="">
                        <div class="article-headings">
                            <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">1996</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">1999</span></span></h6></div>
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="Organization">Pilot</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">Lear Jet</span></h4>
                            <div id="react-tinymce-1032084" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                <ul>
                                    <li><span><span>Responsibilities</span>&nbsp;included <span>passengers</span>, commercial cargo, and aerial photography</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <article data-bind="contents" class="">
                        <div class="article-headings">
                            <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">1992</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">1995</span></span></h6></div>
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="Organization">First Officer</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">Lear Jet</span></h4>
                            <div id="react-tinymce-1032086" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                <p></p>
                                <p><span></span></p>
                            </div>
                        </div>
                ...
                <section data-bind="sections" id="degrees" class="dated_story">
                    ...
                    <article data-bind="contents" class="">
                        <div class="article-headings">
                            <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">1991</span></span><span data-bind="end_date" class="empty"><span class="undefined needsclick empty" contenteditable="false" data-placeholder="YYYY"></span></span></h6></div>
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="School name">Transport Pilot Certificate</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Degree name">Aviation Academy</span></h4>
                            <div id="react-tinymce-1032088" class=" mce-content-body" spellcheck="true" placeholder="Description"></div>
                        </div>
                    </article>
                    <article data-bind="contents" class="">
                        <div class="article-headings">
                            <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">1990</span></span><span data-bind="end_date" class="empty"><span class="undefined needsclick empty" contenteditable="false" data-placeholder="YYYY"></span></span></h6></div>
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="School name">Pilot Certification</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Degree name">Flight School</span></h4>
                            <div id="react-tinymce-1032090" class=" mce-content-body" spellcheck="true" placeholder="Description"></div>
                        </div>
                    </article>
                    <article data-bind="contents" class="">
                        <div class="article-headings">
                            <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">1988</span></span><span data-bind="end_date" class="empty"><span class="undefined needsclick empty" contenteditable="false" data-placeholder="YYYY"></span></span></h6></div>
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="School name">Diploma</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Degree name">State College</span></h4>
                            <div id="react-tinymce-1032092" class=" mce-content-body" spellcheck="true" placeholder="Description"></div>
                        </div>
                    </article>
                </section>
