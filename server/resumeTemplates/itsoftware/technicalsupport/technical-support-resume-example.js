export default ()=>{
    return(
        ...
        <head>
            ...
            <title>Accounting and Technical Support Specialist</title>
        
            <meta name="description" content="Accounting and TechnicalSupport Specialist - ">
        ...
        <body data-cv-id="4942950" class="cv-viewer">
        ...
        Williams</span></h1>
                                    <h2 class="title" data-bind="headline"><span class="undefined needsclick" contenteditable="false" data-placeholder="Headline / current title">Accounting and Technical
        Support Specialist</span></h2></div>
                                <ul class="user-contact">
                                    ...
                                    <li class="email" data-bind="email"><a href="../cdn-cgi/l/email-protection#ef8a828e8683af8a828e8683c18c8082"><span class="__cf_email__" data-cfemail="b3d6ded2dadff3d6ded2dadf9dd0dcde">[email&#160;protected]</span></a></li>
                                </ul>
                        ...
                        <section id="summary" class="text_story">
                            ...
                            <article data-bind="content" class="">
                                <div id="react-tinymce-1032292" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                    <p><strong>Analytical Accounting Support Professional</strong> offering over 15 years of experience providing technical support to accountants utilizing an array of technology and software programs. Subject matter expert in QuickBooks Online US and Canada, QBO Payroll, and ProSeries. Certified change agent, adept at formulating processes and leading teams in achieving excellence in client satisfaction, productivity, and profitability. Seamlessly interfaces with customers and personnel at all levels.&nbsp;</p>
                                </div>
                            </article>
                                ...
                                <section id="positions" class="dated_story">
                                    ...
                                    <article data-bind="contents" class="">
                                        <div class="article-headings">
                                            <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">2003</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">Present</span></span></h6></div>
                                        <div class="article-body">
                                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">Technical
        Support/Sales Specialist             </span></h4>
                                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="Organization">INTUIT INC</span></h5></div>
                                            <div id="react-tinymce-1032294" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                                <p>Facilitated network uninstall and reinstall of tax preparation software for accountants working without internal IT personnel. Supported single-user networks in downloading, installing, and configuring software updates online. Assisted QuickBooks customers with supplies integration.</p>
                                                <ul>
                                                    <li>Identified and resolved malfunctions pertaining to system access for agents, collaborating with agents and the engineering/product development teams.</li>
                                                    <li>Supported QuickBooks desktop and online customers with tips to help clients discover additional features within their software resulting in increased business and streamlined accounting processes.</li>
                                                    <li>Facilitated first time use QBO customers as well as FTU Payroll within their accounts.</li>
                                                    <li>Directed and supported other agents as mentor and subject matter expert in managing escalated issues.</li>
                                                    <li>Routinely worked with Tier 3 agents and engineers to troubleshoot and resolve emerging issues.</li>
                                                    <li>Discovered accounting inaccuracies caused by technical bugs; reported to management to determine resolution.</li>
                                                    <li>Performed comparative research to determine the cause of issues and identify areas needing improvement.</li>
                                                </ul>
                                                <p>&nbsp;</p>
                                                <p><strong><em>Held additional roles with Parsons, Verizon and Bell Atlantic</em></strong></p>
                                            </div>
                                        </div>
                                    </article>
                                </section>
                            ...
                            <div class="sidebar">
                                <section data-bind="sidebar_sections" id="degrees" class="dated_story">
                                    ...
                                    <article data-bind="contents" class="">
                                        ...
                                        <div class="article-body">
                                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Degree name">Microsoft Networking Diploma</span></h4>
                                            <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="School name">Strayer University</span></h5>
                                            <div id="react-tinymce-1032296" class=" mce-content-body" spellcheck="true" placeholder="Description"></div>
                                        </div>
                                    </article>
                                    <article data-bind="contents" class="">
                                        <div class="article-headings">
                                            <h6 class="date-range"><span data-bind="start_date" class="empty"><span class="undefined needsclick empty" contenteditable="false" data-placeholder="YYYY"></span></span><span data-bind="end_date" class="empty"><span class="undefined needsclick empty" contenteditable="false" data-placeholder="YYYY"></span></span></h6></div>
                                        <div class="article-body">
                                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Degree name">Associate of Arts, CIS Programming</span></h4>
                                            <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="School name">Strayer University</span></h5>
                                            <div id="react-tinymce-1032298" class=" mce-content-body" spellcheck="true" placeholder="Description"></div>
                                        </div>
                                    </article>
                                    <article data-bind="contents" class="">
                                        <div class="article-headings">
                                            <h6 class="date-range"><span data-bind="start_date" class="empty"><span class="undefined needsclick empty" contenteditable="false" data-placeholder="YYYY"></span></span><span data-bind="end_date" class="empty"><span class="undefined needsclick empty" contenteditable="false" data-placeholder="YYYY"></span></span></h6></div>
                                        <div class="article-body">
                                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Degree name">Bachelor of Science, Accounting</span></h4>
                                            <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="School name">Strayer University</span></h5>
                                            <div id="react-tinymce-1032300" class=" mce-content-body" spellcheck="true" placeholder="Description"></div>
                                        </div>
                                    </article>
                                </section>
                                <section data-bind="sidebar_sections" id="strengths" class="strengths">
                                    ...
                                    <article class="competency " data-bind="contents">
                                        <div class="article-headings">
                                            <h6 data-bind="name"><span class="undefined needsclick" contenteditable="false" data-placeholder="Name">Hardware/Systems</span></h6></div>
                                        <div class="article-body competency">
                                            <div class="competency-bar">
                                                <div class="competency-level" data-bind="level" style="width:80%"></div>
                                            </div>
                                            <div id="react-tinymce-1032302" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                                <p>Multiplexers, PC/Server, Admin, Routers, Switches, IP Telephony, Mac, Windows</p>
                                            </div>
                                        </div>
                                    </article>
                                    <article class="competency " data-bind="contents">
                                        <div class="article-headings">
                                            <h6 data-bind="name"><span class="undefined needsclick" contenteditable="false" data-placeholder="Name">Databases</span></h6></div>
                                        <div class="article-body competency">
                                            <div class="competency-bar">
                                                <div class="competency-level" data-bind="level" style="width:80%"></div>
                                            </div>
                                            <div id="react-tinymce-1032304" class=" mce-content-body" spellcheck="true" placeholder="Description">Oracle 10G, MS Access</div>
                                        </div>
                                    </article>
                                    <article class="competency " data-bind="contents">
                                        <div class="article-headings">
                                            <h6 data-bind="name"><span class="undefined needsclick" contenteditable="false" data-placeholder="Name">Languages</span></h6></div>
                                        <div class="article-body competency">
                                            <div class="competency-bar">
                                                <div class="competency-level" data-bind="level" style="width:80%"></div>
                                            </div>
                                            <div id="react-tinymce-1032306" class=" mce-content-body" spellcheck="true" placeholder="Description">C++, Unix, Visual Basic, SQL, HTML, VBA</div>
                                        </div>
                                    </article>
                                    <article class="competency " data-bind="contents">
                                        <div class="article-headings">
                                            <h6 data-bind="name"><span class="undefined needsclick" contenteditable="false" data-placeholder="Name">Applications</span></h6></div>
                                        <div class="article-body competency">
                                            <div class="competency-bar">
                                                <div class="competency-level" data-bind="level" style="width:80%"></div>
                                            </div>
                                            <div id="react-tinymce-1032308" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                                <p>Microsoft Office Suite: Word, Excel, Outlook, PowerPoint</p>
                                                <p>QuickBooks, Quicken, ProSeries, Intuit Online Payroll</p>
                                            </div>
                                        </div>
                                    </article>
                                </section>
                        ...
                        <div class="clearfix"></div>
                        <section data-bind="sections" id="text_story_FAv4q4Ge02" class="text_story">
                            <header>
                                <h3 class="header-text empty empty empty empty empty empty empty empty empty" data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Text section">Core Competencies</span></h3></header>
                            <article data-bind="content" class="">
                                <div id="react-tinymce-1032310" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <ul>
                                                        <li>Intuit Online Payroll</li>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li>Monthly Account Reconciliations</li>
