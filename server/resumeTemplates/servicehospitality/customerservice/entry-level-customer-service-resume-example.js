...
<head>
    ...
    <title>Communications &amp; Customer Service Professional - StyleMyCV</title>
    <base href="">
...
<body data-cv-id="708835" class="cv-viewer">
                ...
                <section id="profile" class="profile">
                    <article class="vcard " data-bind="content">
                        ...
                        <div class="fn user-title">
                            <h1 class="full-name" data-bind="full_name"><span class="undefined needsclick" contenteditable="false" data-placeholder="Full name">Judy Watson</span></h1>
...
Communications &amp; Customer Service Professional
                        ...
                        <ul class="user-contact">
                            ...
                            <li class="email" data-bind="email"><a href="../cdn-cgi/l/email-protection#c6a3aba7afaa86a3aba7afaae8a5a9ab"><span class="__cf_email__" data-cfemail="13767e727a7f53767e727a7f3d707c7e">[email&#160;protected]</span></a></li>
                        </ul>
                ...
                <section id="summary" class="text_story">
                    ...
                    <article data-bind="content" class="">
                        <div id="react-tinymce-1031644" class=" mce-content-body" spellcheck="true" placeholder="Description">
                            <p style="text-align: justify; text-justify: inter-ideograph; margin: 0in -9.0pt .0001pt -9.0pt;"></p>
                ...
                <div class="column-container">
                    <div class="main">
                        <section id="positions" class="dated_story">
                            <header>
                                <h3 class="header-text" data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Work experience">Projects and Volunteer Work</span></h3></header>
...
Administrative Assistant &amp;  Social Service Provider </span></h4>
                                    ...
                                    <div id="react-tinymce-1031646" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                        <ul>
                                        ...
                                        <ul>
                                            <li><strong>Major Projects: </strong>Collaborated with a small team to develop an innovative parking system for an Association Name venue that allocated parking spots for up to 600 vehicles &mdash; a significant upgrade from the original system that only supported 350 vehicles. Recently initiated an internal newsletter; presently listed as Content Manager and Editor, coordinating with 6 other volunteers. De-escalates conflicts as they arise at special events, whether related to customer complaints or threatening behavior.</li>
                                        </ul>
                                    </div>
                                </div>
                            </article>
...
Communication Studies &amp; Economics (Honors) </span></h4>
                                    <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="School name">State University</span></h5>
                                    <div id="react-tinymce-1031648" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                        <p style="text-align: left;"><strong><span>Selected Courses</span></strong><strong><span>:</span></strong><span></span></p>
                                        <ul>
                                            <li><span>Financial Accounting I, II, III</span></li>
                                            <li><span>Principles of Marketing</span></li>
                                            <li><span>Interpersonal Communication </span></li>
                                            <li><span>Organizational Communication </span></li>
                        ...
                        <section data-bind="sidebar_sections" id="text_story_509512" class="text_story">
                            <header>
                                <h3 class="header-text empty empty empty empty empty empty empty empty empty" data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Text section">Training</span></h3></header>
                            <article data-bind="content" class="">
                                <div id="react-tinymce-1031650" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                    <p style="text-align: left;"><strong><span style="font-size: 11.0pt; font-family: &#x27;Arial&#x27;,&#x27;sans-serif&#x27;;">Currently Pursuing TESL Trainer/PTCT Instructor Approval</span></strong><span style="font-size: 11.0pt; font-family: &#x27;Arial&#x27;,&#x27;sans-serif&#x27;;"></span></p>
                                    <p style="text-align: left;"><strong><span style="font-size: 11.0pt; font-family: &#x27;Arial&#x27;,&#x27;sans-serif&#x27;;"></span></strong></p>
                                </div>
                            </article>
                        </section>
                ...
                <div class="clearfix"></div>
                <section data-bind="sections" id="text_story_hxpmT9ZCMr" class="text_story">
                    <header>
                    ...
                    <article data-bind="content" class="">
                        <div id="react-tinymce-1031652" class=" mce-content-body" spellcheck="true" placeholder="Description">
                            <table>
                                <tbody>
                                    <tr>
                                        <td>
                ...
                <section data-bind="sections" id="text_story_IUo3f3ztnr" class="text_story">
                    <header>
                        <h3 class="header-text empty empty empty empty empty empty empty empty empty" data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Text section">Relevant Experience and Community Involvement</span></h3></header>
                    <article data-bind="content" class="">
                        <div id="react-tinymce-1031654" class=" mce-content-body" spellcheck="true" placeholder="Description">
                            <p><strong>Personal Sabbatical</strong> Jun. 2011 &ndash; Jul. 2013</p>
                            <p style="text-align: left;">Volunteered English-speaking and writing proficiencies for a family-owned business in Spain, managing and translating confidential materials for highly established personnel. Additionally troubleshot computer-related issues for internal employees.</p>
                        </div>
                    </article>
                </section>
