...
<head>
  ...
  <title>HUMAN RESOURCES PROFESSIONAL</title>
</head>
...
<div>
<link rel="stylesheet" type="text/css" href="https://www.visualcv.com/less/monte?%40primary=%23111111&amp;%40body-font-size=16px&amp;%40section-margins=1em&amp;%40article-margins=1em"/>
    ...
    <div class="cv-content single-column">
        <section data-bind="sections" id="profile" class="profile">
            <article class="vcard " data-bind="content">
                <div class="fn user-title">
                    <h1 class="full-name" data-bind="full_name"><span class="undefined needsclick" contenteditable="false" data-placeholder="Full name">John Vandemar</span></h1></div>
                <ul class="user-contact">
                    <li class="adr locality" data-bind="location"><span class="undefined needsclick" contenteditable="false" data-placeholder="Location">Cardiff</span></li>
                    <li class="phone" data-bind="phone"><span class="undefined needsclick" contenteditable="false" data-placeholder="Phone">+00000000</span></li>
                    <li class="email" data-bind="email"><a href="../cdn-cgi/l/email-protection#0c626d61694c69616d6560226f6361"><span class="__cf_email__" data-cfemail="741a151911341119151d185a171b19">[email&#160;protected]</span></a></li>
                </ul>
        ...
        <section data-bind="sections" id="summary" class="text_story">
            ...
            <article data-bind="content" class="">
                <div id="react-tinymce-1031250" class=" mce-content-body" spellcheck="true" placeholder="Description">
                    <p style="text-align: left;"><span>Award-winning and versatile Certified Human Resources Professional (CHRP) with 10 years of expertise strengthening human resources for teams around the globe. Strong understanding of recruitment, staffing, immigration, mergers, acquisitions, onboarding, training, performance management, compensation, and benefits. Known as a resourceful team player who excels in challenging environments. </span></p>
                    <ul>
                        <li style="text-align: left;"><span style="text-align: left; font-size: 18.4px;">Captured significant savings and improved availability of benefits through tremendous success negotiating 0% increases in benefits premiums for two consecutive years; industry averages 14% increases annually.</span></li>
                        <li style="text-align: left;"><span>Recognized for success transforming underperforming teams; reinvented human resources strategies and resolved issues in critical areas such as recruitment, performance management, and compensation. </span></li>
                        <li style="text-align: left;"><span>Earned first-of-its-kind &ldquo;Going the Extra Mile Award&rdquo; for leadership in consistently promoting customer service for global company with 900+ employees. <br/></span></li>
                    </ul>
                </div>
            </article>
        </section>
        <section data-bind="sections" id="text_story" class="text_story">
            <header>
                <h3 class="header-text empty" data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Text section">Core Competencies</span></h3></header>
            <article data-bind="content" class="">
                <div id="react-tinymce-1031252" class=" mce-content-body" spellcheck="true" placeholder="Description">
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <ul>
                                        ...
                                        <li><span>Team Motivation</span></li>
        ...
        <section data-bind="sections" id="positions" class="dated_story">
            <header>
                <h3 class="header-text empty"
                data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Work experience">Work experience</span></h3></header>
          ...
          COMPANY, LLC, City, State 

    </span></h5></div>
                    <div id="react-tinymce-1031254" class=" mce-content-body" spellcheck="true" placeholder="Description">
                        <p><span>Recruited by former officer of acquired company dmg world media to transition human resources operations. Directed team leading full range of human resources functions, including payroll, recruiting, and benefits, for locations in the United States and Canada. Partnered with senior management to deploy innovative long-term human resources solutions. Allocated $1.5 million budget, aligning financial resources with business objectives.</span></p>
                        <ul>
                            <li>Instrumental contributor to success of human resources transition during acquisition of dmg world media; ensured seamless changeover by establishing bank accounts, payroll systems, benefits plans, and other critical systems in only 30 days.</li>
                            <li>Selected to direct recruitment strategies from concept to completion, developing overall workforce planning and presenting recommendations approved by senior management.</li>
                            <li>Strengthened business operations by creating and deploying performance management tools, including new compensation strategies incorporating new pay grades and bonus and commission structures.</li>
                            <li>Launched comprehensive benefits program, including group retirement and 401(k) plans, throughout locations in the United States and Canada; traveled to 12+ offices in North America to facilitate launch.&nbsp;</li>
                        </ul>
                    </div>
                </div>
            </article>
            <article data-bind="contents" class="">
                <div class="article-headings">
                    <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">2003</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">2006</span></span></h6></div>
                <div class="article-body">
                    <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">
              ...
              COMPANY, City, State 
                    ...
                    <div id="react-tinymce-1031256" class=" mce-content-body" spellcheck="true" placeholder="Description">
                        <p>Directed five-person team overseeing human resources for North American locations, managing $2.3 million budget. Developed comprehensive hiring strategy to attract talent, including increasing web presence.&nbsp;</p>
                    </div>
                </div>
            </article>
            <article data-bind="contents" class="">
                <div class="article-headings">
                    <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">2001</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">2003</span></span></h6></div>
                <div class="article-body">
                    <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">
              ...
              COMPANY, City, State 
                    ...
                    <div id="react-tinymce-1031258" class=" mce-content-body" spellcheck="true" placeholder="Description">
                        <p>Managed all human resources issues, serving as primary human resources contact for employees globally. Spearheaded initiatives that improved recruitment, talent assessment, training and development, performance management, retention, employee satisfaction, compensation procedures, and staffing. Significantly improved productivity by establishing best practices for payroll, performance metrics, and other policies, bringing congruity to procedures across teams.</p>
                        <ul>
                            <li>Decreased potential liabilities by ensuring compliance with employment laws, including handling complaints of discrimination and harassment.</li>
                        </ul>
                    </div>
                </div>
            </article>
            <article data-bind="contents" class="">
              ...
              COMPANY, City, State 
                    ...
                    <div id="react-tinymce-1031260" class=" mce-content-body" spellcheck="true" placeholder="Description">
                        <p>Controlled multiple aspects of human resources, including recruitment, performance and disciplinary actions, and payroll. Also introduced stock option plan as element of compensation structure.</p>
                        <ul>
                            <li><span> </span><span>Led seamless transition of HRIS/payroll systems from ADP to Ceridian Systems. </span></li>
                        </ul>
                    </div>
                </div>
            </article>
        </section>
        <section data-bind="sections" id="text_story_m-3ZF1155l" class="text_story">
            <header>
                <h3 class="header-text" data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Text section">Education</span></h3></header>
            <article data-bind="content" class="">
                <div id="react-tinymce-1031262" class=" mce-content-body" spellcheck="true" placeholder="Description">
                    <ul>
                        <li><strong>Certificate in Human Resources Management</strong><span>: Humber College of Applied Arts &amp; Technology, City, State</span></li>
                        <li><strong>Certified Human Resources Professional&nbsp;</strong><span><strong>(CHRP)</strong>, Human Resources Professionals Association</span></li>
                        <li><strong>Certification: Human Resources Generalist Program</strong><span>, Society for Human Resource Management</span></li>
                        <li><strong>Certification: International Human Resources Management</strong><span>, Society for Human Resource Management</span></li>
                        <li><strong>Certification: Interviewing &amp; Selecting Exceptional People</strong><span>, MICA Management</span></li>
                    </ul>
                </div>
            </article>
        </section>
        <section data-bind="sections" id="text_story_Sc-OGohAgR" class="text_story">
            <header>
                <h3 class="header-text" data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Text section">Affiliations</span></h3></header>
            <article data-bind="content" class="">
                <div id="react-tinymce-1031264" class=" mce-content-body" spellcheck="true" placeholder="Description">
                    <ul>
                        <li><span>Human Resources Professionals Association (HRPA),</span></li>
                        <li><span>Member </span><span></span><span>Annual Conference Chairperson (2005, 2006, 2007)</span></li>
                        <li><span>Society of Human Resource Management (SHRM), Member</span></li>
                    </ul>
                </div>
            </article>
        </section>
        <section data-bind="sections" id="text_story_Zg4NW0aX_3" class="text_story">
            <header>
                <h3 class="header-text" data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Text section">Technical Skills</span></h3></header>
            <article data-bind="content" class="">
                <div id="react-tinymce-1031266" class=" mce-content-body" spellcheck="true" placeholder="Description">
                    <p><span>ADP Pay Expert, ADP PC for Windows, Ceridian in-Sync, Microsoft Office (Word, Excel, Outlook)</span></p>
                </div>
            </article>
        </section>
...
<footer class="vcv-footer">
  <p>
    <time datetime="2018-04-03T21:13:33Z" pubdate="pubdate" class="updated-at">
