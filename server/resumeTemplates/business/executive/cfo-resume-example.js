...
<body data-cv-id="1755894" class="cv-viewer">
    ...
    <div>
        <link rel="stylesheet" type="text/css" href="https://www.visualcv.com/less/corporate?%40primary=black&amp;%40body-font-size=14px&amp;%40article-margins=1.5em&amp;%40logo-url=" />
                ...
                <section data-bind="profile" class="header-bar profile" id="profile">
                    <article class="vcard " data-bind="content"><img class="user-thumb photo" data-bind="thumb" />
                        ...
                        <div class="fn user-title">
                            <h1 class="full-name" data-bind="full_name"><span class="undefined needsclick" contenteditable="false" data-placeholder="Full name">Miles Messervy</span></h1>
                ...
                <div class="flex-columns">
                    <div class="sidebar">
                            ...
                            <article class="contact_info " data-bind="content">
                                <div class="adr">
                                    <ul class="user-contact">
                                        <li class="adr locality" data-bind="location"><span class="undefined needsclick" contenteditable="false" data-placeholder="Location">Toronto, CA</span></li>
                                        <li class="phone" data-bind="phone"><span class="undefined needsclick" contenteditable="false" data-placeholder="Phone">+15555551212</span></li>
                                        <li class="email" data-bind="email"><a href="../cdn-cgi/l/email-protection#fc99919d9590bc9b919d9590d29f9391"><span class="__cf_email__" data-cfemail="7e1b131f17123e19131f1712501d1113">[email&#160;protected]</span></a></li>
                                    </ul>
                        ...
                        <section data-bind="sidebar_sections" class="text-section text_story" id="text_story">
                            <header>
                                <h3 class="header-text empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty" data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Text section">QUALIFICATIONS</span></h3></header>
                            <article data-bind="content" class="">
                                <div id="react-tinymce-1031198" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                    <p><span>Seasoned Financial Executive with solid and progressive experience in all facets of accounting and financial management. Possess Certified Public Accountant license in the State of New Jersey. Highly skilled in collaborating with all members of the organization to achieve business and financial objectives. Adept in streamlining financial processes, enhancing productivity levels, and introducing process improvements. Proficient in Microsoft Office, MAS 500, Wall Street Office, and Peachtree.</span></p>
                                </div>
                            </article>
                        </section>
                        <section data-bind="sidebar_sections" class="text-section text_story" id="text_story_fRg1GAheGg">
                            <header>
                                <h3 class="header-text empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty" data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Text section">Core Competencies</span></h3></header>
                            <article data-bind="content" class="">
                                <div id="react-tinymce-1031200" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                    <ul>
                        ...
                        <section data-bind="sidebar_sections" class="text-section text_story" id="text_story_lSrxHatrf2">
                            <header>
                                <h3 class="header-text empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty" data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Text section">Highlights</span></h3></header>
                            <article data-bind="content" class="">
                                <div id="react-tinymce-1031202" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                    <ul>
                        ...
                        <section data-bind="sidebar_sections" class="text-section text_story" id="text_story_3lPcAJrn2N">
                            <header>
                                <h3 class="header-text empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty" data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Text section">Affiliations</span></h3></header>
                            <article data-bind="content" class="">
                                <div id="react-tinymce-1031204" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                    <ul>
                    ...
                    <div class="main">
                        <section data-bind="sections" id="positions" class="dated_story">
                            <header>
                                <h3 class="header-text empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty empty" data-bind="label"><span class="undefined needsclick" contenteditable="false" data-placeholder="Work experience">Professional Background</span></h3></header>
                            <article data-bind="contents" class="empty ">
                                <div class="article-headings">
                                    <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">2007</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">Present</span></span></h6></div>
                                <div class="article-body">
                                    <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">Chief Financial Officer
					...
					Com Group, Inc. – Florham Park, NJ 
                                    ...
                                    <div id="react-tinymce-1031206" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                        <p><span>Provided leadership and direction to all aspects of accounting, financial management, fund management, and controllership relating to GNV. Reviewed monthly, quarterly, and annual financial statement closing process, which included all SEC required filings.<br/> </span></p>
                            ...
                            <article data-bind="contents" class="empty ">
                                <div class="article-headings">
                                    <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">2001</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">2006</span></span></h6></div>
                                <div class="article-body">
					...
					Managing Director, Accounting &amp; Finance
                            ...
                            <article data-bind="contents" class="empty ">
                                <div class="article-headings">
                                    <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">1998</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">2001</span></span></h6></div>
                                <div class="article-body">
                                    <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">
							...
							Company Corporate Headquarters – Madison, NJ 
                                    ...
                                    <div id="react-tinymce-1031210" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                        <p>Maintained accountability for all aspects of auditing functions. Determined audit scope and coordinated audit fieldwork. Supervised and coached audit staff during operational and financial audits. Drafted and presented audit reports to senior management.</p>
                                        <p><strong><em>Key Achievements:</em></strong></p>
                                        <ul>
                            ...
                            <article data-bind="contents" class="empty ">
                                <div class="article-headings">
                                    <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">1996</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">1998</span></span></h6></div>
                                <div class="article-body">
                                    <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">
							...
							Company LLP – Roseland, NJ 
                                    ...
                                    <div id="react-tinymce-1031212" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                        <p>Provided direction to audit engagements from inception through completion. Coordinated fieldwork with the client. Led audits in manufacturing and professional services industries.</p>
                                        <p><strong><em>Key Achievements:</em></strong></p>
                                        <ul>
                            ...
                            <article data-bind="contents" class="empty ">
                                <div class="article-headings">
                                    <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">1994</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">1996</span></span></h6></div>
                                <div class="article-body">
                                    <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">Staff Auditor</span></h4>
                                    <div data-bind="organization_url" target="_blank" rel="nofollow">
                                        <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="Organization">
							...
							Company LLP – Roseland, NJ 
                                    ...
                                    <div id="react-tinymce-1031214" class=" mce-content-body" spellcheck="true" placeholder="Description"></div>
                                </div>
                            </article>
                        </section>
                        <section data-bind="sections" id="degrees" class="dated_story">
							...
							Seton Hall University 
                                    ...
                                    <div id="react-tinymce-1031216" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                        <ul>
