...
<head>
    ...
    <title>Secretary and office manager</title>

    <meta name="description" content="Secretary and office manager">
...
<body data-cv-id="3095721" class="cv-viewer">
            ...
            <div class="cv-content single-column">
                <section id="profile" class="profile">
                    <article class="vcard " data-bind="content">
                        <div class="user-thumb visible" data-bind="thumb">
                            <div class="css-crop bg-cover" style="background-image:url(https://workstory.s3.amazonaws.com/assets/1742039/pexels-photo-220453_cv.jpeg)"></div>
                        </div>
                        <div class="fn user-title">
                            <h1 class="full-name" data-bind="full_name"><span class="undefined needsclick" contenteditable="false" data-placeholder="Full name">Alex Yaffe</span></h1>
                            <div class="block-separator"></div>
                            <h2 class="title" data-bind="headline"><span class="undefined needsclick" contenteditable="false" data-placeholder="Headline / current title">Secretary and office manager</span></h2></div>
                        <ul class="user-contact">
                            <li class="adr locality" data-bind="location"><span class="undefined needsclick" contenteditable="false" data-placeholder="Location">Vancouver, BC</span></li>
                            <li class="phone" data-bind="phone"><span class="undefined needsclick" contenteditable="false" data-placeholder="Phone">(555) 555-5555</span></li>
                            <li class="email" data-bind="email"><a href="../cdn-cgi/l/email-protection#345159555d5874514c55594458511a575b59"><span class="__cf_email__" data-cfemail="e3868e828a8fa3869b828e938f86cd808c8e">[email&#160;protected]</span></a></li>
                        </ul>
                ...
                <section data-bind="sections" id="summary" class="text_story">
                    ...
                    <article data-bind="content" class="">
                        <div id="react-tinymce-1031484" class=" mce-content-body" spellcheck="true" placeholder="Description">
                            <p><span>Experienced secretary and office manager with skills in administration, <span>booking</span>, and coordination. A great communicator with a passion for maintaining open lines of communication and establishing a healthy, welcoming workplace.</span>
                            </p>
                                    ...
                                    <tr>
                                        <td>
                                            <ul>
                                                ...
                                                <li><span>Agenda setting</span></li>
                                            </ul>
                                        </td>
                                        <td>
                                            <ul>
                                                <li>Booking appointments</li>
                                                <li><span>Managing clients and customers</span></li>
                                            </ul>
                                        </td>
                                        <td>
                                            <ul>
                ...
                <section data-bind="sections" id="positions" class="dated_story">
                    ...
                    <article data-bind="contents" class="">
                        <div class="article-headings">
                            <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">March 2016</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">Present</span></span></h6></div>
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="Organization">Chain Industries</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">Secretary To Chief Executive Officer</span></h4>
                            <div id="react-tinymce-1031486" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                <ul>
                                    <li>Answering telephone calls</li>
                                    <li>Maintaining <span>agenda</span>&nbsp;</li>
                                    <li>Implementing new procedures and administrative systems</li>
                                    <li>Liaising with relevant organizations</li>
                                    <li>Coordinating mail-shots and similar publicity tasks.&nbsp;</li>
                                </ul>
                            </div>
                        </div>
                    </article>
                    <article data-bind="contents" class="">
                        <div class="article-headings">
                            <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">Jan 2015</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">Feb 2016</span></span></h6></div>
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="Organization">Chain Industries</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">Executive Secretary</span></h4>
                            <div id="react-tinymce-1031488" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                <ul>
                                    <li>Filing organizing and servicing meetings, including producing agendas and taking minutes</li>
                                    <li>Training and supervising junior staff</li>
                                    <li>Handling correspondence</li>
                                    <li>Arranging and scheduling appointments</li>
                                    <li>Taking messages</li>
                                    <li>Typing and word processing&nbsp;</li>
                                </ul>
                            </div>
                        </div>
                    </article>
                    <article data-bind="contents" class="">
                        <div class="article-headings">
                            <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">Jan 2011</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">Dec 2014</span></span></h6></div>
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="Organization">Quality Office</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">Secretary</span></h4>
                            <div id="react-tinymce-1031490" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                <ul>
                                    <li>Prepared and managed correspondence, reports and documents</li>
                                    <li>Organized and coordinated meetings, conferences, and travel arrangements</li>
                                    <li>Met with <span>g</span>uests and customers</li>
                                    <li>Handled correspondence&nbsp;</li>
                                    <li>Handled administrative duties such as typing <span>messages</span>, answering phones, and copy editing</li>
                                </ul>
                            </div>
                        </div>
                    </article>
                    <article data-bind="contents" class="">
                        <div class="article-headings">
                            <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">May 2008</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">Dec 2010</span></span></h6></div>
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="Organization">John Smart Paper Company</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">Office Administrator</span></h4>
                            <div id="react-tinymce-1031492" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                <ul>
                                    <li>Responsible for handling administrative duties</li>
                                    <li>Responsible for scheduling appointments with clients</li>
                                    <li>Photocopying, filing and documenting processes</li>
                                </ul>
                            </div>
                        </div>
                    </article>
                    <article data-bind="contents" class="">
                        <div class="article-headings">
                            <h6 class="date-range"><span data-bind="start_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">Jun 2007</span></span><span data-bind="end_date"><span class="undefined needsclick" contenteditable="false" data-placeholder="YYYY">Apr 2008</span></span></h6></div>
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="Organization">Pekoe Insurance</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Job title">Receptionist</span></h4>
                            <div id="react-tinymce-1031494" class=" mce-content-body" spellcheck="true" placeholder="Description">
                                <ul>
                                    <li>Booking <span>clients</span>&nbsp;</li>
                                    <li>Office administration</li>
                                    <li>Typing reports</li>
                                </ul>
                            </div>
                        </div>
                    </article>
                ...
                <section data-bind="sections" id="degrees" class="dated_story">
                    ...
                    <article data-bind="contents" class="">
                        ...
                        <div class="article-body">
                            <div data-bind="organization_url" target="_blank" rel="nofollow">
                                <h5 data-bind="organization"><span class="undefined needsclick" contenteditable="false" data-placeholder="School name">Province Polytechnic</span></h5></div>
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Degree name">Diploma, General Studies</span></h4>
                            <div id="react-tinymce-1031496" class=" mce-content-body" spellcheck="true" placeholder="Description"></div>
                        </div>
                    </article>
                    <article data-bind="contents" class="">
                        <div class="article-headings">
                        ...
                        <div class="article-body">
                            ...
                            <h4 data-bind="title"><span class="undefined needsclick" contenteditable="false" data-placeholder="Degree name">Bachelor of Fine Arts</span></h4>
                            <div id="react-tinymce-1031498" class=" mce-content-body" spellcheck="true" placeholder="Description"></div>
                        </div>
                    </article>
                </section>
